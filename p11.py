...
def array_product(array, n):
    '''Finds max product of 4 consecutive numbers in an array of size n, left-right, up-down, diagonal'''
    max_product = 0
    ...
    for i in range(n):
        ...
        for j in range(n):
            ...
            # (n-3) to avoid out-of-range
            # Could improve code to take in different length of consecutive numbers, not just 4
